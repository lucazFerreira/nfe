package com.sigraweb.documentofiscal.nfe400;
...
import com.sigraweb.documentofiscal.nfe400.classes.NFEndereco;
import com.sigraweb.documentofiscal.nfe400.classes.NFFinalidade;
import com.sigraweb.documentofiscal.nfe400.classes.NFIndicadorFormaPagamento;
...
import com.sigraweb.documentofiscal.nfe400.classes.NFProtocolo;
import com.sigraweb.documentofiscal.nfe400.classes.NFProtocoloInfo;
...
import com.sigraweb.documentofiscal.nfe400.classes.evento.NFEvento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.NFInfoEvento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.NFTipoEvento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.cancelamento.NFEnviaEventoCancelamento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.cancelamento.NFEventoCancelamento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.cancelamento.NFInfoCancelamento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.cancelamento.NFInfoEventoCancelamento;
import com.sigraweb.documentofiscal.nfe400.classes.evento.cartacorrecao.NFEnviaEventoCartaCorrecao;
import com.sigraweb.documentofiscal.nfe400.classes.evento.inutilizacao.NFEnviaEventoInutilizacao;
import com.sigraweb.documentofiscal.nfe400.classes.evento.inutilizacao.NFEventoInutilizacaoDados;
import com.sigraweb.documentofiscal.nfe400.classes.evento.manifestacaodestinatario.NFEventoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe400.classes.evento.manifestacaodestinatario.NFInfoEventoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe400.classes.evento.manifestacaodestinatario.NFInfoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe400.classes.lote.envio.NFLoteEnvio;
import com.sigraweb.documentofiscal.nfe400.classes.lote.envio.NFLoteEnvioRetornoRecebimentoInfo;
import com.sigraweb.documentofiscal.nfe400.classes.lote.envio.NFLoteIndicadorProcessamento;
...
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFImpostoDevolvido;
...
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFInfoCupomFiscalReferenciado;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFInfoModelo1Por1AReferenciada;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFInfoProdutorRuralReferenciada;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFInfoReferenciada;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFInformacaoImpostoDevolvido;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFMeioPagamento;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNota;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfo;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoAvulsa;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCana;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCanaDeducao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCanaFornecimentoDiario;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCartao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCobranca;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoCompra;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoDestinatario;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoEmitente;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoExportacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoFatura;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoFormaPagamento;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoICMSTotal;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoISSQNTotal;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoIdentificacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoInformacoesAdicionais;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItem;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemDetalheExportacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemExportacaoIndireta;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImposto;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINS;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINSAliquota;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINSNaoTributavel;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINSOutrasOperacoes;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINSQuantidade;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoCOFINSST;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoICMS;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoICMS00;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoICMSUFDestino;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoIPI;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoIPINaoTributado;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoIPITributado;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoISSQN;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoImportacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPIS;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPISAliquota;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPISNaoTributado;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPISOutrasOperacoes;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPISQuantidade;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemImpostoPISST;
...
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProduto;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoArmamento;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoCombustivel;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoCombustivelCIDE;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoMedicamento;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoRastreabilidade;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoItemProdutoVeiculo;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoLacre;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoLocal;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoObservacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoPagamento;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoParcela;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoProcessoReferenciado;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoReboque;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoRegimeEspecialTributacao;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoRetencaoICMSTransporte;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoRetencoesTributos;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoTotal;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoTransportador;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoTransporte;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoVeiculo;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaInfoVolume;
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFNotaProcessada;
...
import com.sigraweb.documentofiscal.nfe400.classes.nota.NFPessoaAutorizadaDownloadNFe;
...
import com.sigraweb.documentofiscal.nfe400.classes.nota.assinatura.NFReference;
import com.sigraweb.documentofiscal.nfe400.classes.nota.assinatura.NFSignature;
import com.sigraweb.documentofiscal.nfe400.classes.nota.assinatura.NFSignedInfo;
import com.sigraweb.documentofiscal.nfe400.classes.statusservico.consulta.NFStatusServicoConsulta;
import com.sigraweb.documentofiscal.nfe400.classes.statusservico.consulta.NFStatusServicoConsultaRetorno;
