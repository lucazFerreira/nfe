package com.sigraweb.documentofiscal.nfe310;
...
import com.sigraweb.documentofiscal.nfe310.classes.NFEndereco;
...
import com.sigraweb.documentofiscal.nfe310.classes.NFNotaInfoItemProdutoArmamentoTipo;
...
import com.sigraweb.documentofiscal.nfe310.classes.NFNotaInfoSituacaoTributariaCOFINS;
import com.sigraweb.documentofiscal.nfe310.classes.NFNotaInfoSituacaoTributariaIPI;
import com.sigraweb.documentofiscal.nfe310.classes.NFNotaInfoSituacaoTributariaPIS;
...
import com.sigraweb.documentofiscal.nfe310.classes.NFOrigemProcesso;
...
import com.sigraweb.documentofiscal.nfe310.classes.NFProtocolo;
import com.sigraweb.documentofiscal.nfe310.classes.NFProtocoloInfo;
import com.sigraweb.documentofiscal.nfe310.classes.NFRegimeTributario;
import com.sigraweb.documentofiscal.nfe310.classes.NFTipo;
import com.sigraweb.documentofiscal.nfe310.classes.NFTipoImpressao;
import com.sigraweb.documentofiscal.nfe310.classes.evento.NFEvento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.NFInfoEvento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.NFTipoEvento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.cancelamento.NFEnviaEventoCancelamento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.cancelamento.NFEventoCancelamento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.cancelamento.NFInfoCancelamento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.cancelamento.NFInfoEventoCancelamento;
import com.sigraweb.documentofiscal.nfe310.classes.evento.cartacorrecao.NFEnviaEventoCartaCorrecao;
import com.sigraweb.documentofiscal.nfe310.classes.evento.inutilizacao.NFEnviaEventoInutilizacao;
import com.sigraweb.documentofiscal.nfe310.classes.evento.inutilizacao.NFEventoInutilizacaoDados;
import com.sigraweb.documentofiscal.nfe310.classes.evento.manifestacaodestinatario.NFEventoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe310.classes.evento.manifestacaodestinatario.NFInfoEventoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe310.classes.evento.manifestacaodestinatario.NFInfoManifestacaoDestinatario;
import com.sigraweb.documentofiscal.nfe310.classes.lote.envio.NFLoteEnvio;
import com.sigraweb.documentofiscal.nfe310.classes.lote.envio.NFLoteEnvioRetornoRecebimentoInfo;
...
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFIdentificadorLocalDestinoOperacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFImpostoDevolvido;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFIndicadorIEDestinatario;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFIndicadorPresencaComprador;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFInfoCupomFiscalReferenciado;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFInfoModelo1Por1AReferenciada;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFInfoProdutorRuralReferenciada;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFInfoReferenciada;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFInformacaoImpostoDevolvido;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNota;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfo;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoAvulsa;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCana;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCanaDeducao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCanaFornecimentoDiario;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCartao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCobranca;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoCompra;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoDestinatario;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoDuplicata;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoEmitente;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoExportacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoFatura;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoICMSTotal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoISSQNTotal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoIdentificacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoInformacoesAdicionais;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItem;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemDetalheExportacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemExportacaoIndireta;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImposto;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINS;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINSAliquota;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINSNaoTributavel;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINSOutrasOperacoes;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINSQuantidade;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoCOFINSST;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoICMS;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoICMS00;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoICMSUFDestino;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoIPI;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoIPINaoTributado;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoIPITributado;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoISSQN;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoImportacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPIS;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPISAliquota;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPISNaoTributado;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPISOutrasOperacoes;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPISQuantidade;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoPISST;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemIndicadorExigibilidadeISS;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemIndicadorIncentivoFiscal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProduto;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoArmamento;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoCombustivel;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoCombustivelCIDE;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoDeclaracaoImportacaoAdicao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoMedicamento;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoItemProdutoVeiculo;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoLacre;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoLocal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoObservacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoPagamento;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoProcessoReferenciado;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoReboque;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoRegimeEspecialTributacao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoRetencaoICMSTransporte;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoRetencoesTributos;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoTotal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoTransportador;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoTransporte;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoVeiculo;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaInfoVolume;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFNotaProcessada;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFOperacaoConsumidorFinal;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFOperadoraCartao;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFPessoaAutorizadaDownloadNFe;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFTipoIntegracaoPagamento;
import com.sigraweb.documentofiscal.nfe310.classes.nota.NFViaTransporteInternacional;
import com.sigraweb.documentofiscal.nfe310.classes.nota.assinatura.NFReference;
import com.sigraweb.documentofiscal.nfe310.classes.nota.assinatura.NFSignature;
import com.sigraweb.documentofiscal.nfe310.classes.nota.assinatura.NFSignedInfo;
