package com.sigraweb.documentofiscal.cte.webservices.distribuicao;
...
public class CTeDistribuicaoDFeSoapStub extends org.apache.axis2.client.Stub {
    ...
    public CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse cteDistDFeInteresse(final CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse cteDistDFeInteresse) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse.class, this.getEnvelopeNamespaces(_returnEnv));
            return (CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse) object;
    ...
    private org.apache.axiom.om.OMElement toOM(final CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse param, final boolean optimizeContent) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse.class.equals(type)) {
                return CTeDistribuicaoDFeSoapStub.CteDistDFeInteresse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse.class.equals(type)) {
                return CTeDistribuicaoDFeSoapStub.CteDistDFeInteresseResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
